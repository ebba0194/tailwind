  ...
  <div className="grid grid-row-4 m-8 rounded-lg p-8 shadow-lg radial-bg border-2 border-soapStone">
    <div className="grid grid-cols-1">
      <div className="flex items-center justify-end text-base">
        <a href="/" className="rounded-full w-8 h-8 border border-zeus border-opacity-10 flex items-center justify-center hover:text-soapStone hover:bg-zeus transition duration-150 ease-in-out">
    ...
    <div className="grid grid-cols-1 text-center items-end text-gigas font-bold pt-8">
